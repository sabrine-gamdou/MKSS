...
INSERT INTO types (name) SELECT 'hamster' WHERE NOT EXISTS (SELECT * FROM specialties WHERE name='hamster');
...
INSERT INTO owners (first_name, last_name, address, zip_code, city, telephone) SELECT 'George', 'Franklin', '110 W. Liberty St.', 23568, 'Madison', '6085551023' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=1);
INSERT INTO owners (first_name, last_name, address, zip_code, city, telephone) SELECT 'Betty', 'Davis', '638 Cardinal Ave.', 4577, 'Sun Prairie', '6085551749' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=2);
INSERT INTO owners (first_name, last_name, address, zip_code, city, telephone) SELECT 'Eduardo', 'Rodriquez', '2693 Commerce St.', 1237, 'McFarland', '6085558763' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=3);
INSERT INTO owners (first_name, last_name, address, zip_code, city, telephone) SELECT 'Harold', 'Davis', '563 Friendly St.',  25368,'Windsor', '6085553198' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=4);
INSERT INTO owners (first_name, last_name, address, zip_code, city, telephone) SELECT 'Peter', 'McTavish', '2387 S. Fair Way', 78952, 'Madison', '6085552765' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=5);
INSERT INTO owners (first_name, last_name, address, zip_code, city, telephone) SELECT 'Jean', 'Coleman', '105 N. Lake St.',  10023,'Monona', '6085552654' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=6);
INSERT INTO owners (first_name, last_name, address, zip_code, city, telephone) SELECT 'Jeff', 'Black', '1450 Oak Blvd.',  1258,'Monona', '6085555387' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=7);
INSERT INTO owners (first_name, last_name, address, zip_code, city, telephone) SELECT 'Maria', 'Escobito', '345 Maple St.', 3002, 'Madison', '6085557683' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=8);
INSERT INTO owners (first_name, last_name, address, zip_code, city, telephone) SELECT 'David', 'Schroeder', '2749 Blackhawk Trail', 45412,'Madison', '6085559435' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=9);
INSERT INTO owners (first_name, last_name, address, zip_code, city, telephone) SELECT 'Carlos', 'Estaban', '2335 Independence La.', 1258,'Waunakee', '6085555487' WHERE NOT EXISTS (SELECT * FROM owners WHERE id=10);
...
INSERT INTO visits (pet_id, visit_date, description, vet_id) SELECT 7, '2010-03-04', 'rabies shot',1 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=1);
INSERT INTO visits (pet_id, visit_date, description, vet_id) SELECT 8, '2011-03-04', 'rabies shot',1 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=2);
INSERT INTO visits (pet_id, visit_date, description, vet_id) SELECT 8, '2009-06-04', 'neutered',2 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=3);
INSERT INTO visits (pet_id, visit_date, description, vet_id) SELECT 7, '2008-09-04', 'spayed',4 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=4);
